...
function content_65de29ede8c369_75517145 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_89723167165de29ede4f448_12506798', 'step_content');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, 'checkout/_partials/steps/checkout-step.tpl');
}
/* {block 'step_content'} */
class Block_89723167165de29ede4f448_12506798 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'step_content' => 
  array (
    0 => 'Block_89723167165de29ede4f448_12506798',
  ),
);
      ...
      <?php if ($_smarty_tpl->tpl_vars['use_same_address']->value) {?>
        <p>
          <?php if ($_smarty_tpl->tpl_vars['cart']->value['is_virtual']) {?>
            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Enter Address if you need invoice.','d'=>'Shop.Theme.Checkout'),$_smarty_tpl ) );?>
